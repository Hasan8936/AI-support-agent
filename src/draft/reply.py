...
def _safe_resolution(text: str) -> str:
    """Never copy a tweet verbatim or invite public sharing of sensitive data."""
...
def draft_reply(_message: str, intent: str, precedents: List[Dict[str, Any]]) -> str:
    ...
    # The historic resolution supplies the action. The generated framing avoids
    # claiming an order-specific outcome the model cannot verify.
